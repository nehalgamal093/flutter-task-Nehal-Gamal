...
class ColorManager{
  ...
  static Color bGrey = Color(0xD000000);
  static Color lightOrangeClr = Color(0xdf95b1c);
  static Color redClr = Color(0xffFF4144);

  static Color bBlueClr = Color(0xff3B4CF2);
  static Color cBlueColor = Color(0xff0079FE);
  static Color whiteClr = Color(0xffffffff);
  static Color lightBlueClr = Color(0xd0079fe);
}